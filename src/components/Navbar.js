    ...
    <nav className="navbar">
        ...
        <div className="header-bar">
            ...
            <ul className="nav-links">
                <li>
                    <Link to="about" spy={true} smooth={true} offset={0} duration={200} className={`link ${isActiveLink === 'experience' ? 'active' : ''}`} >About</Link>
                </li>
                <li>
                ...
                <li>
                    <Link to="contact" spy={true} smooth={true} offset={0} duration={200} className={`link ${isActiveLink === 'experience' ? 'active' : ''}`}>Contact</Link>
                </li>
                <li>
                    <div
